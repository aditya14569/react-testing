...
class Eligibility extends Component {
  state = {
    orderForm: {
      ...
      issue: {
        ...
        elementConfig: {
          options: [
            { value: "Material Repair", displayValue: "Material Repair" },
            { value: "New Material", displayValue: "New Material" }
          ]
        },
        value: "Material Repair",
        valid: true,
        validation: {}
      },
      material: {
  ...
  orderHandler = event => {
    ...
    const data = {
      ...
      manpowerrequired: formData.manpowerrequired,
  ...
  render() {
    ...
    return (
      <div className="ContactData">
        <p>Facility-related->Sports Material</p>
