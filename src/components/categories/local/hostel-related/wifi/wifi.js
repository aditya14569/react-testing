  ...
  state = {
    orderForm: {
      ...
      issue: {
        ...
        elementConfig: {
          options: [
            { value: "Connectivity", displayValue: "Connectivity" },
            { value: "Range", displayValue: "Range" },
            { value: "Speed", displayValue: "Speed" }
          ]
        },
        value: "Connectivity",
        valid: true,
      ...
      problemarea: {
        ...
        elementConfig: {
          options: [
            { value: "Bandwidth", displayValue: "Bandwidth" },
            { value: "LAN Wire", displayValue: "LAN Wire" },
            { value: "Ports", displayValue: "Ports" },
            { value: "WIFRouter", displayValue: "WIFRouter" }
          ]
        },
        value: "Bandwidth",
        valid: true,
