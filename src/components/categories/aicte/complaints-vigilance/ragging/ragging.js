...
class Eligibility extends Component {
    state = {
        orderForm: {
            ...
            nearest_vigilance_enforcer: {
                ...
                elementConfig: {
                    type: 'text',
                    placeholder: 'nearest vigilance enforcer'
                },
                value: '',
                validation: {
                    required: true,
    ...
    orderHandler = (event) => {
        ...
        const data = {
            ...
            accused_names:formData.accused_names,
            nearest_vigilance_enforcer:formData.nearest_vigilance_enforcer,
            place:formData.place,
            time:formData.time,
            victim_id:formData.victim_id,
            victim_names:formData.victim_names,
    ...
    render() {
        ...
        return (
            <div className='ContactData'>
                <p>Complaints-Vigilance->Ragging</p>
