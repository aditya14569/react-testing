...
class Eligibility extends Component {
    state = {
        orderForm: {
            ...
            certificate_central_to_grievance: {
                ...
                elementConfig: {
                    type: 'text',
                    placeholder: 'certificate central to grievance'
                },
                value: '',
                validation: {
                    required: true
            ...
            complaint_expected_status: {
                ...
                elementConfig: {
                    type: 'text',
                    placeholder: 'complaint expected status'
                },
                value: '',
                validation: {
                    required: true
    ...
    orderHandler = (event) => {
        ...
        const data = {
            ...
            complaint_expected_status:formData.complaint_expected_status,
            certificate_central_to_grievance:formData.certificate_central_to_grievance,
    ...
    render() {
        ...
        return (
            ...
            <p>Complaints-Vigilance->Certificate</p>
