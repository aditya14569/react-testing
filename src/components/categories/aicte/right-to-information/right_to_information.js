...
class Eligibility extends Component {
    state = {
        orderForm: {
            ...
            specifications_of_information_needed: {
                ...
                elementConfig: {
                    type: 'text',
                    placeholder: 'specification of information needed'
                },
                value: '',
                validation: {
                    required: true,
            ...
            reason_of_need_for_rti: {
                ...
                elementConfig: {
                    type: 'text',
                    placeholder: 'reason of need for rti'
                },
                value: '',
                validation: {
                    required: true
    ...
    orderHandler = (event) => {
        ...
        const data = {
            ...
            specifications_of_information_needed:formData.specifications_of_information_needed,
            reason_of_need_for_rti:formData.reason_of_need_for_rti,
